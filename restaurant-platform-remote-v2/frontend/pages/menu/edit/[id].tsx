...
export default function EditMenuPage() {
  ...
  const fetchMenuData = async () => {
    try {
      ...
      setFormData({
        ...
        branchIds: menu.branches.map((mb: any) => mb.branch.id),
        channels: menu.channels.map((mc: any) => mc.channelCode),
        productIds: menu.products.map((mp: any) => mp.product.id),
  ...
  return (
    <ProtectedRoute>
      <Head>
        <title>Edit Menu | Restaurant Platform</title>
      </Head>
