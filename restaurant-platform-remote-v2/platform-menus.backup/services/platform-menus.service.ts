  ...
  async createMenu(
    ...
    const menu = await this.prisma.platformMenu.create({
      data: {
        ...
        platformConfig: createMenuDto.platformConfig || {},
        displayConfig: createMenuDto.displayConfig || {},
        activeFrom: createMenuDto.activeFrom,
        activeUntil: createMenuDto.activeUntil,
        scheduleConfig: createMenuDto.scheduleConfig,
